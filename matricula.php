        ...
        <section id="matricula">
            ...
            <div class="container-fluid">
                <div class="row d-flex justify-content-center" style="padding-left:8%;padding-right:8%;">
                    <div class="col-md-4 px-3 my-3">
                        <a href="view5.php?id=1">
                            <div class="card shadow-sm h-100" style="background: rgb(248, 248, 248);">
                                ...
                                <img src="./public/img/galeria/requisito-matricula.png" width="100%" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="pt-3">
                                            <h5 class="fw-bold text-uppercase" style="font-size: 18px;color:var(--color4);">REQUISITOS PARA LA MATRICULA</h5>
                                        </div>
                                    </div>
                                    <div class="detalle">
                                        Estimado estudiante se le felicita por haber sido promovidos al ciclo superior.
                                    </div>
                                </div>

                                <div class="card-footer text-info d-flex justify-content-center align-items-center my-auto" style="color: var(--color4);">

                                    <a href="view5.php?id=1" style="color: var(--color1);">Ver más&nbsp;&nbsp;&nbsp;<i class="fas fa-external-link-alt"></i></a>
                                </div>
                    ...
                    <div class="col-md-4 px-3 my-3">
                        <a href="view5.php?id=2">
                            <div class="card shadow-sm h-100" style="background: rgb(248, 248, 248);">
                                <!-- <span class="news">Admision</span> -->
                                <img src="./public/img/galeria/formulario-datos.jpg" width="100%" height="300">
                                ...
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="pt-3">
                                            <h5 class="fw-bold text-uppercase" style="font-size: 18px;color:var(--color4);">FORMULARIO DE DATOS</h5>
                                        </div>
                                ...
                                <div class="card-footer text-info d-flex justify-content-center align-items-center my-auto">
                                    ...
                                    <a href="view5.php?id=2" style="color: var(--color1);">Ver más&nbsp;&nbsp;&nbsp;<i class="fas fa-external-link-alt"></i></a>
                                </div>
                    ...
                    <div class="col-md-4 px-3 my-3">
                        <a href="view5.php?id=3">
                            <div class="card shadow-sm h-100" style="background: rgb(248, 248, 248);">
                                <!-- <span class="news">Admision</span> -->
                                <img src="./public/img/galeria/conectividad-recursos.jpg" width="100%" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="pt-3">
                                            <h5 class="fw-bold text-uppercase" style="font-size: 18px;color:var(--color4);">FORMULARIO CONDICIONES DE CONECTIVIDAD Y RECURSOS</h5>
                                        </div>

                                    </div>

                                    <div class="detalle">
                                        Estimados Docentes y Administrativos, se les pide que llenen este formulario de manera honesta y con información actualizada.
                                    </div>
                                ...
                                <div class="card-footer text-info d-flex justify-content-center align-items-center my-auto">
                                    ...
                                    <a href="view5.php?id=3" style="color: var(--color1);">Ver más&nbsp;&nbsp;&nbsp;<i class="fas fa-external-link-alt"></i></a>
                                </div>
                    ...
                    <div class="col-md-4 px-3 my-3">
                        <a href="view5.php?id=4">
                            <div class="card shadow-sm h-100" style="background: rgb(248, 248, 248);">
                                <!-- <span class="news">Admision</span> -->
                                <img src="./public/img/galeria/socio-economia.jpg" width="100%" height="300">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="pt-3">
                                            <h5 class="fw-bold text-uppercase" style="font-size: 18px;color:var(--color4);">FICHA SOCIO ECONÓMICA DEL ESTUDIANTE</h5>
                                        </div>

                                    </div>

                                    <div class="detalle">
                                        Completa tu ficha Socio Económica del Estudiante.
                                    </div>
                                ...
                                <div class="card-footer text-info d-flex justify-content-center align-items-center my-auto">
                                    ...
                                    <a href="view5.php?id=4" style="color: var(--color1);">Ver más&nbsp;&nbsp;&nbsp;<i class="fas fa-external-link-alt"></i></a>
                                </div>
